...
const CACHE=CACHE_PREFIX+'0.7.0';
const ASSETS=['./','./index.html','./style.css','./workspace.css','./app.js','./core.js','./storage.js','./ui.js','./events.js','./gestures.js','./runtime.js','./dialogs.js','./layout.js','./mobile.js','./mobile.css','./landscape.css','./controllers.js','./analysis-client.js','./visuals.js','./exchange.js','./exchange-core.js','./exchange-xml.js','./webmcp.js','./demo-data.js','./audio/waveform.js','./audio/waveform-worker.js','./icon.svg','./manifest.webmanifest','./audio/engine.js','./audio/processor.js','./audio/beatgrid.js','./audio/analysis.js','./demos/demo-0.wav','./demos/demo-1.wav','./demos/demo-2.wav','./demos/demo-3.wav'];
