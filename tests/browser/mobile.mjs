...
export async function runMobile(browser,url){
 ...
 try{
  ...
  await page.locator('button[data-mobile-deck="3"]').tap();
  assert.equal(await page.locator('[data-panel=deck3]').isVisible(),true);
  await page.locator('button[data-mobile-view=library]').tap();
  await overflow();
  ...
  await page.locator('button[data-mobile-view=mixer]').tap();
  ...
  await page.locator('button[data-mobile-view=sampler]').tap();
  await overflow();
  ...
  await page.locator('button[data-mobile-view=deck]').tap();
  await page.locator('[data-panel=deck3] [data-action=play]').tap();
  ...
  await page.locator('button[data-mobile-view=library]').tap();await overflow();
